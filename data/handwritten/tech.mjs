...
export default [
{
  ...
  se: 'A recipe is an algorithm: same steps in, same cake out.',
  sz: '菜谱就是一种算法：步骤照做，蛋糕照出。',
  s2: 'A good algorithm beats a fast machine.',
  z2: '好算法胜过快机器。'
},
{
  ...
  se: 'Looking both ways before you cross is a heuristic, not a proof.',
  sz: '过马路前左右看看是启发式，不是证明。',
  s2: 'When the search is too big to finish, a heuristic is all you have.',
  z2: '当搜索大到跑不完，你手里就只剩启发式了。'
},
{
  ...
  se: 'Water runs down the steepest gradient of the hill.',
  sz: '水沿着山坡最陡的方向往下流。',
...
},
{
  ...
  se: 'Rolling a die is stochastic. Setting an alarm is not.',
  sz: '掷骰子是随机的，定闹钟不是。',
  s2: 'Stochastic methods trade certainty for speed.',
  z2: '随机方法用确定性换速度。'
},
{
  ...
  se: 'One epoch is one full lap around the whole training set.',
  sz: '一个 epoch 就是把整个训练集跑完一圈。',
  s2: 'The model stopped improving after the twelfth epoch.',
  z2: '第十二轮之后模型就不再变好了。'
},
{
  ...
  se: 'A number is a dot, a list is a line, a tensor is any number of dimensions.',
  sz: '一个数是点，一列数是线，张量则可以有任意多维。',
  s2: 'Everything a neural network touches is a tensor.',
  z2: '神经网络碰到的每样东西都是张量。'
},
{
  ...
  se: 'A convolution slides a small window over a picture, one step at a time.',
  sz: '卷积就是拿一个小窗口在图上一格一格地滑过去。',
  s2: 'Convolutions are why a model can spot an edge anywhere in the image.',
  z2: '正因为有卷积，模型才能在图上任何位置认出边缘。'
},
{
  ...
  se: 'A perceptron adds up its inputs and answers yes or no.',
  sz: '感知机把输入加起来，然后回答是或否。',
  s2: 'One perceptron cannot even learn "exactly one of the two".',
  z2: '单个感知机连“二者恰有其一”都学不会。'
},
{
  ...
  se: 'Regularization is telling a student to explain it simply, not to memorise the book.',
  sz: '正则化就像要求学生讲清道理，而不是把书背下来。',
  s2: 'Without regularization the model memorises instead of learning.',
  z2: '没有正则化，模型只会背而不会学。'
},
{
  ...
  se: 'Overfitting is passing the mock exam and failing the real one.',
  sz: '过拟合就是模拟考满分、真考不及格。',
  s2: 'The training loss fell while the test loss rose - textbook overfitting.',
  z2: '训练损失在降、测试损失在升，教科书式的过拟合。'
},
{
  ...
  se: 'Training is studying. Inference is sitting the exam.',
  sz: '训练是复习，推理是考试。',
  s2: 'Most of the cost is not training but inference.',
  z2: '大部分成本不在训练，而在推理。'
},
{
  ...
  se: 'A bathroom scale that always reads two kilos heavy has a bias.',
  sz: '总是多称两公斤的体重秤，就是有偏差。',
  s2: 'High bias means the model is too simple to see the pattern.',
  z2: '高偏差意味着模型太简单，看不出规律。'
},
{
  ...
  se: 'Ask five friends the same question and the answers scatter - that scatter is variance.',
  sz: '问五个朋友同一个问题，答案的分散程度就是方差。',
  s2: 'Averaging many models cuts variance without adding bias.',
  z2: '把多个模型平均可以降方差，又不增偏差。'
},
{
  ...
  se: 'A fair coin carries more entropy than a coin that always lands heads.',
  sz: '公平硬币的熵比总是正面的硬币高。',
  s2: 'The more surprising the message, the more entropy it carries.',
  z2: '消息越出人意料，携带的熵就越多。'
},
{
  ...
  se: 'An embedding puts "king" and "queen" near each other on a map of meaning.',
  sz: '嵌入把 king 和 queen 放在意义地图上彼此相邻的位置。',
  s2: 'Search works by finding the nearest embedding.',
  z2: '检索靠的就是找最近的那个嵌入向量。'
},
{
  ...
  se: 'A fever is visible; the infection behind it is latent.',
  sz: '发烧看得见，背后的感染是潜在的。',
  s2: 'The model compresses each face into a few latent numbers.',
  z2: '模型把每张脸压缩成几个潜变量。'
},
{
  ...
  se: 'A corpus is the whole pile of text you learn from.',
  sz: '语料库就是你用来学习的那一整堆文本。',
  s2: 'They cleaned the corpus before training anything.',
  z2: '他们在训练之前先把语料库清洗了一遍。'
},
{
  ...
  se: 'To a model, "unhappiness" may arrive as three tokens, not one word.',
  sz: '在模型眼里 unhappiness 可能是三个 token，而不是一个词。',
  s2: 'You pay by the million tokens, not by the question.',
  z2: '计费按百万 token，而不是按问题数。'
},
{
  ...
  se: 'Reading "the cat sat on it", you look back to find what "it" means. That is attention.',
  sz: '读到 the cat sat on it，你会回头找 it 指什么 —— 这就是注意力。',
  s2: 'Attention lets every word look at every other word.',
  z2: '注意力让每个词都能看到其他所有词。'
},
{
  ...
  se: 'The transformer reads a whole sentence at once instead of word by word.',
  sz: 'Transformer 一次读完整句，而不是一个词一个词地读。',
  s2: 'Almost every modern language model is a transformer.',
  z2: '如今几乎所有语言模型都是 Transformer。'
},
{
  ...
  se: 'Quantization is measuring in centimetres instead of micrometres.',
  sz: '量化就是改用厘米而不是微米去量。',
  s2: 'Four-bit quantization let the model fit on one graphics card.',
  z2: '四比特量化让模型装进了一张显卡。'
},
{
  ...
  se: 'A hallucination is a confident answer with nothing behind it.',
  sz: '幻觉就是说得很笃定、背后却什么依据都没有。',
  s2: 'Fluent writing makes a hallucination hard to spot.',
  z2: '文笔越流畅，幻觉越难被发现。'
},
{
  ...
  se: 'Ask three doctors and go with the majority - that is an ensemble.',
  sz: '问三位医生然后少数服从多数，这就是集成。',
  s2: 'An ensemble is almost always better than its best member.',
  z2: '集成的效果几乎总好过其中最强的那一个。'
},
{
  ...
  se: 'A blacksmith cools hot metal slowly so it settles without cracking.',
  sz: '铁匠让烧红的金属慢慢冷却，好让它稳定下来而不开裂。',
  s2: 'We anneal the learning rate: big steps first, tiny steps later.',
  z2: '我们对学习率退火：先迈大步，后迈小步。'
},
{
  ...
  se: 'A textbook distils a whole library into three hundred pages.',
  sz: '一本教科书把整座图书馆蒸馏成三百页。',
  s2: 'Distillation kept most of the accuracy at a tenth of the size.',
  z2: '蒸馏让体积缩到十分之一，准确率却基本保住。'
},
{
  ...
  se: 'A red dot on a white wall is salient - your eye goes straight to it.',
  sz: '白墙上的一个红点很显著，眼睛会直接看过去。',
  s2: 'The saliency map showed the model was reading the watermark, not the animal.',
  z2: '显著性图显示模型看的是水印，不是那只动物。'
},
{
  ...
  se: 'One person walking backwards in a crowd is an anomaly.',
  sz: '人群里唯一倒着走的那个人就是异常。',
  s2: 'The alert fires when today looks nothing like last week.',
  z2: '当今天完全不像上周时，告警就会响。'
},
{
  ...
  se: 'A map is flat, yet it describes a round planet. Real data lives on such a folded surface.',
  sz: '地图是平的，却能描述一个球形星球。真实数据就活在这样的折叠曲面上。',
  s2: 'That is why two faces can be blended smoothly into a third.',
  z2: '这就是为什么两张脸可以平滑地融成第三张。'
},
{
  ...
  se: 'The oven temperature is a hyperparameter; the cake is what gets learned.',
  sz: '烤箱温度是超参数，蛋糕才是学出来的东西。',
  s2: 'You choose hyperparameters; the model chooses everything else.',
  z2: '超参数由你定，其余的由模型自己定。'
},
{
  ...
  se: 'A robust bridge still stands when a lorry is heavier than planned.',
  sz: '稳健的桥在卡车超重时依然立得住。',
  s2: 'It scored well on clean photos and fell apart on blurry ones.',
  z2: '它在清晰照片上分数很好，一遇模糊图就崩了。'
},
{
  ...
  se: 'Remove the salt and taste again - now you know what the salt was doing.',
  sz: '把盐拿掉再尝一口，你就知道盐起了什么作用。',
  s2: 'The ablation showed the gain came from the data, not the design.',
  z2: '消融实验表明，提升来自数据而不是设计。'
},
{
  ...
  se: 'A well-calibrated forecaster who says "70% rain" is right about 70% of the time.',
  sz: '校准良好的预报员说“七成下雨”，就大约有七成时候会下。',
  s2: 'Being right often is not the same as knowing when you are unsure.',
  z2: '经常答对，和知道自己什么时候没把握，是两回事。'
},
{
  ...
  se: 'Show the model two photos of the same cat and one of a dog, and let it sort them out.',
  sz: '给模型看同一只猫的两张照片和一只狗的照片，让它自己分开。',
  s2: 'Contrastive training pulls the matching pair together and pushes the rest away.',
  z2: '对比训练把配对的拉近，把其余的推远。'
},
{
  ...
  se: 'No single ant is clever, yet the colony builds tunnels.',
  sz: '没有一只蚂蚁聪明，蚁群却挖出了隧道。',
  s2: 'The ability was never trained for; it just showed up at scale.',
  z2: '这个能力从未被训练过，规模上去就自己冒出来了。'
},
{
  ...
  se: 'Perplexity of eight means the model is as unsure as picking from eight words.',
  sz: '困惑度为八，就相当于在八个词里犹豫。',
  s2: 'Lower perplexity, less hesitation.',
  z2: '困惑度越低，犹豫越少。'
},
{
  ...
  se: 'Most of the sky is empty; you only store the stars.',
  sz: '天空大部分是空的，你只需要记下星星。',
  s2: 'Sparsity is how a huge model stays cheap to run.',
  z2: '稀疏性是巨大模型仍然跑得便宜的原因。'
},
{
  ...
  se: 'You cannot weigh happiness, so you count smiles instead.',
  sz: '幸福没法称，于是你去数笑容。',
  s2: 'Accuracy is a surrogate for what the product actually needs.',
  z2: '准确率只是产品真正需求的替身。'
},
{
  ...
  se: 'A doctor who says "you are ill" is useless; you want to know why.',
  sz: '医生只说“你病了”没有用，你想知道为什么。',
  s2: 'Interpretability is being able to follow the reason, not just the answer.',
  z2: '可解释性是能跟上理由，而不只是拿到答案。'
},
{
  ...
  se: 'Two mirrors facing each other show a room inside a room inside a room.',
  sz: '两面镜子对着照，房间里套着房间，一层又一层。',
  s2: 'Every recursion needs a stopping rule, or it never comes back.',
  z2: '每个递归都要有停下来的规则，否则它永远回不来。'
},
{
  ...
  se: 'Stirring the soup ten times is ten iterations.',
  sz: '把汤搅十下，就是十次迭代。',
  s2: 'The answer settled after nine iterations.',
  z2: '九次迭代之后答案就稳定了。'
},
{
  ...
  se: 'Visiting every room in a house exactly once is a traversal.',
  sz: '把屋里每个房间恰好走一遍，就是遍历。',
  s2: 'Walk the tree in the right order and the list comes out sorted.',
  z2: '按对的顺序遍历这棵树，输出就是排好序的。'
},
{
  ...
  se: 'A heap is a pile where the biggest thing is always on top.',
  sz: '堆就是一摞东西，最大的那个永远在最上面。',
  s2: 'You can always grab the largest item without searching.',
  z2: '你随时能拿到最大的那个，不用去找。'
},
{
  ...
  se: 'A queue is a shop till: first in, first served.',
  sz: '队列就是超市收银台，先来先结账。',
  s2: 'Breadth-first search explores with a queue.',
  z2: '广度优先搜索靠队列来推进。'
},
{
  ...
  se: 'A stack is a pile of plates: you take the top one.',
  sz: '栈就是一摞盘子，你只能拿最上面那个。',
  s2: 'A stack overflow means the recursion never stopped.',
  z2: '栈溢出意味着递归一直没停下来。'
},
{
  ...
  se: 'A hash turns any book into a short fingerprint.',
  sz: '哈希把任何一本书变成一小段指纹。',
  s2: 'Change one letter and the fingerprint changes completely.',
  z2: '改动一个字母，指纹就完全变了。'
},
{
  ...
  se: 'Two different books ending up with the same fingerprint is a collision.',
  sz: '两本不同的书算出同一个指纹，就是碰撞。',
  s2: 'Good hashing makes collisions rare, not impossible.',
  z2: '好的哈希让碰撞变罕见，而不是不可能。'
},
{
  ...
  se: 'Pick one card, put smaller ones left and bigger ones right. That card is the pivot.',
  sz: '挑一张牌，小的放左边大的放右边，这张牌就是基准。',
  s2: 'Picking the pivot at random keeps the sort fast.',
  z2: '随机挑基准元素能让排序保持快速。'
},
{
  ...
  se: 'Write the answer in the margin so you never work it out twice.',
  sz: '把答案写在页边，同一题就不必算第二遍。',
  s2: 'Memoization turns a slow Fibonacci into an instant one.',
  z2: '记忆化把慢得离谱的斐波那契变成瞬间出结果。'
},
{
  ...
  se: 'A yearly ticket costs a lot once, then nothing for months.',
  sz: '年票一次付很多钱，之后几个月都不用再花。',
  s2: 'Adding to a growing list is amortized cheap: occasionally slow, usually instant.',
  z2: '往会增长的列表里加元素是摊还便宜的：偶尔慢，通常瞬间完成。'
},
{
  ...
  se: 'Ask not "how fast on ten items" but "how fast on ten million".',
  sz: '别问“十个元素多快”，要问“一千万个多快”。',
  s2: 'Two methods can tie asymptotically and differ tenfold in practice.',
  z2: '两种方法渐近相同，实测却能差十倍。'
},
{
  ...
  se: 'Doubling the input, does the work double, or square?',
  sz: '输入翻倍，工作量是翻倍，还是变成平方？',
  s2: 'It runs in n log n time but needs n memory.',
  z2: '它的时间是 n log n，内存却要 n。'
},
{
  ...
  se: 'Always taking the biggest coin first is greedy - and sometimes wrong.',
  sz: '永远先拿最大的硬币就是贪心 —— 有时候会错。',
  s2: 'Here the greedy choice happens to be the best one.',
  z2: '在这个问题上，贪心选择恰好就是最优的。'
},
{
  ...
  se: 'In a maze you walk back to the last fork and try the other way.',
  sz: '走迷宫时你退回上一个岔路口，改走另一边。',
  s2: 'Placing eight queens on a chessboard is the classic backtracking puzzle.',
  z2: '八皇后是回溯法的经典题。'
},
{
  ...
  se: 'ABC, ACB, BAC - each ordering is one permutation.',
  sz: 'ABC、ACB、BAC，每一种排法就是一个排列。',
  s2: 'Ten items already have over three million permutations.',
  z2: '十个元素的排列已经超过三百万种。'
},
{
  ...
  se: 'On a balance scale, both sides stay equal no matter what you add - that is an invariant.',
  sz: '天平两边不管加什么都保持相等，这就是不变量。',
  s2: 'State the invariant and the proof almost writes itself.',
  z2: '把不变量写清楚，证明几乎就自己写出来了。'
},
{
  ...
  se: 'A subway map ignores distance; only what connects to what matters.',
  sz: '地铁图不管距离，只关心谁连着谁。',
  s2: 'You can only sort tasks in order if the graph has no loops.',
  z2: '只有当图里没有环，任务才能排出先后顺序。'
},
{
  ...
  se: 'Type "the" and a trie already knows about "there", "these", "they".',
  sz: '你打出 the，字典树就已经知道 there、these、they。',
  s2: 'Every keystroke walks one step further down the tree.',
  z2: '每敲一个键，就沿着树往下走一步。'
},
{
  ...
  se: 'Below 37.5 you are fine; above it you have a fever. That line is the threshold.',
  sz: '低于 37.5 度没事，高于就算发烧，这条线就是阈值。',
  s2: 'Lower the threshold and you catch more cases - and more false alarms.',
  z2: '把阈值调低，抓到的病例更多，误报也更多。'
},
{
  ...
  se: 'Put a marker card at the end of the deck so you always know when to stop.',
  sz: '在牌堆末尾放一张标记牌，你就总知道什么时候停。',
  s2: 'A sentinel removes every "is it empty?" check from the loop.',
  z2: '有了哨兵，循环里所有“是不是空的”判断都能省掉。'
},
{
  ...
  se: 'A vending machine is deterministic: same coin, same can, every time.',
  sz: '自动售货机是确定性的：同样的硬币，每次出同样的罐子。',
  s2: 'Fix the random seed and the whole run becomes deterministic.',
  z2: '固定随机种子，整次运行就变成确定性的。'
},
{
  ...
  se: 'Your age is monotonic: it only ever goes up.',
  sz: '年龄是单调的：只会往上走。',
  s2: 'A monotonic stack finds the next taller person in one pass.',
  z2: '单调栈一次扫描就能找出下一个更高的人。'
},
{
  ...
  se: 'Every seat has one ticket and every ticket has one seat.',
  sz: '每个座位对应一张票，每张票对应一个座位。',
  s2: 'Build a bijection and the two sets must be the same size.',
  z2: '能造出双射，两个集合就一样大。'
},
{
  ...
  se: 'A bowl is convex: drop a marble anywhere and it rolls to the same bottom.',
  sz: '碗是凸的：珠子从哪儿放下去都滚到同一个底。',
  s2: 'On a convex landscape, local best is global best.',
  z2: '在凸的地形上，局部最优就是全局最优。'
},
{
  ...
  se: 'Two jigsaws with different pictures but identical cuts are isomorphic.',
  sz: '两幅图案不同、切法完全相同的拼图，就是同构的。',
  s2: 'Rename the nodes and one graph becomes the other.',
  z2: '把节点改个名字，一张图就变成了另一张。'
},
{
  ...
  se: 'A dictionary sorts "cat" before "cats" before "dog".',
  sz: '词典把 cat 排在 cats 前面，cats 排在 dog 前面。',
  s2: 'Sort by the first field, break ties with the second.',
  z2: '先按第一项排，相同再看第二项。'
},
{
  ...
  se: 'A lock is fine until someone builds a key shaped to jam it.',
  sz: '锁本来好好的，直到有人专门做了把卡住它的钥匙。',
  s2: 'That input was not bad luck; it was built to break the code.',
  z2: '那个输入不是运气不好，是专门造出来搞垮代码的。'
},
{
  ...
  se: 'A jigsaw of a hundred pieces is tractable. A million is not.',
  sz: '一百片的拼图是可解的，一百万片就不是。',
  s2: 'Drop one constraint and the problem becomes tractable.',
  z2: '放松一个约束，问题就变得可解了。'
},
{
  ...
  se: 'If Ann is taller than Bob and Bob than Carl, Ann is taller than Carl.',
  sz: '安比鲍勃高，鲍勃比卡尔高，那么安比卡尔高。',
  s2: 'Dependencies are transitive, which is why one small update can break everything.',
  z2: '依赖是可传递的，所以一个小更新能搞垮一切。'
},
{
  ...
  se: 'A gardener cuts the branches that will never bear fruit.',
  sz: '园丁剪掉那些永远结不了果的枝条。',
  s2: 'Once you know a branch cannot win, stop searching it.',
  z2: '一旦知道某条分支赢不了，就别再往下搜。'
},
{
  ...
  se: 'Tidying a kitchen changes where things live, not what you can cook.',
  sz: '整理厨房改变的是东西放哪，不是你能做什么菜。',
  s2: 'Refactor first, then add the feature.',
  z2: '先重构，再加功能。'
},
{
  ...
  se: 'Pressing a lift button twice does not make it come faster.',
  sz: '电梯按钮按两下，电梯不会来得更快。',
  s2: 'Make the endpoint idempotent and a repeated request does no harm.',
  z2: '把接口做成幂等的，重复请求就无害了。'
},
{
  ...
  se: 'The old road still works, but every sign points to the new one.',
  sz: '老路还能走，但所有路牌都指向新路。',
  s2: 'It is deprecated in this version and gone in the next.',
  z2: '这个版本已弃用，下个版本就没有了。'
},
{
  ...
  se: 'A leak somewhere in the house: your job is to find which pipe.',
  sz: '屋里某处在漏水，你的任务是找出是哪根管子。',
  s2: 'Half of debugging is making the problem happen on demand.',
  z2: '调试有一半功夫花在“让问题按需复现”上。'
},
{
  ...
  se: 'A translator turns your speech into a language the other side understands.',
  sz: '译员把你的话转成对方听得懂的语言。',
  s2: 'It compiles, which proves almost nothing.',
  z2: '它能编译通过，这几乎什么都证明不了。'
},
{
  ...
  se: 'A repository keeps every draft of the essay, not just the final one.',
  sz: '仓库保存这篇文章的每一稿，而不只是定稿。',
  s2: 'Clone the repository and you get the whole history with it.',
  z2: '克隆仓库，你连整部历史一起拿到。'
},
{
  ...
  se: 'Signing the visitors book: from now on, everyone can see you were here.',
  sz: '在来访登记簿上签字：从此人人都看得到你来过。',
  s2: 'Write the commit message for whoever reads it in a year.',
  z2: '提交信息要写给一年后读它的人看。'
},
{
  ...
  se: 'Two people edit the same shopping list; someone has to combine them.',
  sz: '两个人各自改了同一张购物清单，总得有人把它们合起来。',
  s2: 'Most merge pain comes from waiting too long to merge.',
  z2: '合并的痛苦大多来自拖太久才合。'
},
{
  ...
  se: 'A patient recovers, then gets the same illness again.',
  sz: '病人好了，然后又得了同一个病。',
  s2: 'Add a test that fails before the fix and passes after.',
  z2: '加一个测试：修复前失败，修复后通过。'
},
{
  ...
  se: 'Deploying is opening the shop doors, not stocking the shelves.',
  sz: '部署是开门营业，不是理货上架。',
  s2: 'Deploy on a Tuesday morning, never on a Friday night.',
  z2: '部署选周二上午，绝不要选周五晚上。'
},
{
  ...
  se: 'The cake is the artifact; the recipe is the source.',
  sz: '蛋糕是产物，菜谱是源码。',
  s2: 'Build it once, then ship the very same bytes everywhere.',
  z2: '只构建一次，然后把同一份字节送到各处。'
},
{
  ...
  se: 'A printed book cannot be edited; you print a new edition.',
  sz: '印好的书改不了，你只能出新版。',
  s2: 'Immutable data is safe to share between threads without locks.',
  z2: '不可变数据可以在线程间共享而不用加锁。'
},
{
  ...
  se: '"Open" works on a door, a bottle and a file, in three different ways.',
  sz: '“打开”用在门、瓶子、文件上，是三种不同的动作。',
  s2: 'One interface, many implementations behind it.',
  z2: '一个接口，背后是许多种实现。'
},
{
  ...
  se: 'You drive with the pedals; you never touch the engine.',
  sz: '你用踏板开车，从不去碰发动机。',
  s2: 'Encapsulation is what lets you swap the database later.',
  z2: '正因为封装，你日后才换得掉数据库。'
},
{
  ...
  se: 'A map leaves out every tree so you can see the road.',
  sz: '地图省掉每一棵树，你才看得见路。',
  s2: 'Every abstraction leaks; the question is how much.',
  z2: '所有抽象都会漏，问题只在漏多少。'
},
{
  ...
  se: 'Flat-packing furniture so it fits in a box.',
  sz: '把家具拆平打包，才装得进箱子。',
  s2: 'Never unpack data from a stranger straight into live objects.',
  z2: '绝不要把陌生人给的数据直接还原成活对象。'
},
{
  ...
  se: 'A crash-test dummy sits in for a person.',
  sz: '碰撞测试假人替真人坐在车里。',
  s2: 'Mock the payment gateway; never charge a real card in a test.',
  z2: '把支付网关 mock 掉，测试里绝不要真的刷卡。'
},
{
  ...
  se: 'A tree stump is what is left when the trunk is cut away.',
  sz: '树桩是树干被砍走后剩下的东西。',
  s2: 'Start with a stub so people can review the shape early.',
  z2: '先写个桩，好让别人尽早评审它的形状。'
},
{
  ...
  se: 'You inherit a house with wiring nobody can explain.',
  sz: '你继承了一栋房子，里面的电线没人说得清。',
  s2: 'Legacy code is simply code without tests.',
  z2: '所谓遗留代码，就是没有测试的代码。'
},
{
  ...
  se: 'The first compiler had to be written in something else. After that, in itself.',
  sz: '第一个编译器只能用别的语言写，之后就能用它自己写了。',
  s2: 'Pulling yourself up by your own bootstraps is impossible - which is the joke.',
  z2: '拽着自己的靴带把自己提起来是不可能的 —— 这正是这个词的玩笑所在。'
},
{
  ...
  se: 'Miners carried a canary because the bird fainted before they did.',
  sz: '矿工带着金丝雀，因为鸟会比人先晕倒。',
  s2: 'Send one percent of traffic first and watch what breaks.',
  z2: '先放百分之一的流量过去，看看会坏什么。'
},
{
  ...
  se: 'A car with no dashboard still drives - until it does not.',
  sz: '没有仪表盘的车照样能开，直到开不动为止。',
  s2: 'You cannot debug what you cannot see.',
  z2: '看不见的东西，你没法调试。'
},
{
  ...
  se: 'A weather station on a mountain sends its readings down the wire.',
  sz: '山顶的气象站把读数顺着线路发下来。',
  s2: 'Sample the telemetry; you do not need every single event.',
  z2: '对遥测数据采样，不必上报每一条。'
},
{
  ...
  se: 'A toolbox holds tools. A drawer holding tools, socks and bills has low cohesion.',
  sz: '工具箱只放工具。工具、袜子、账单混一抽屉，内聚就低。',
  s2: 'High cohesion inside, loose coupling outside.',
  z2: '对内高内聚，对外低耦合。'
},
{
  ...
  se: 'If moving your desk means moving mine too, our desks are coupled.',
  sz: '如果你挪桌子我也得跟着挪，我们的桌子就是耦合的。',
  s2: 'The worst coupling is the kind nobody wrote down.',
  z2: '最糟的耦合是没人写下来的那种。'
},
{
  ...
  se: 'Do you lock the whole library, or just one book?',
  sz: '你是锁整座图书馆，还是只锁一本书？',
  s2: 'Choose the granularity before you choose the lock.',
  z2: '先决定粒度，再决定用哪种锁。'
},
{
  ...
  se: 'Grammatically correct is not the same as how people actually speak.',
  sz: '语法正确，和母语者真会那么说，是两回事。',
  s2: 'It works, but no Go programmer would write it that way.',
  z2: '它能跑，但没有 Go 程序员会那么写。'
},
{
  ...
  se: 'A thermometer does not cook the food; it tells you how hot it is.',
  sz: '温度计不做饭，它只告诉你有多热。',
  s2: 'Bad instrumentation costs more than none at all.',
  z2: '糟糕的埋点比不埋点代价更大。'
},
{
  ...
  se: 'A painting sells for more when you can prove who owned it.',
  sz: '一幅画能证明流传有序，就更值钱。',
  s2: 'Sign the build so anyone can check where it came from.',
  z2: '给构建产物签名，谁都能查它从哪来。'
},
{
  ...
  se: 'A phone call interrupts your phone call, and both still make sense.',
  sz: '一通电话打断另一通，两边都还讲得下去。',
  s2: 'Signal handlers may only call reentrant functions.',
  z2: '信号处理函数只能调用可重入的函数。'
},
{
  ...
  se: 'One cook, three pans: nothing happens at the same instant, yet all three dishes advance.',
  sz: '一个厨师三口锅：没有哪一刻真的同时在做，三道菜却都在推进。',
  s2: 'Concurrency is about structure; parallelism is about doing things at once.',
  z2: '并发讲的是结构，并行讲的才是同时执行。'
},
{
  ...
  se: 'One key to the toilet. Whoever holds it, everyone else waits.',
  sz: '厕所只有一把钥匙，谁拿着，其他人就等着。',
  s2: 'Hold the mutex for as short a time as you can.',
  z2: '持有互斥锁的时间越短越好。'
},
{
  ...
  se: 'A car park with forty spaces: the counter at the gate is a semaphore.',
  sz: '有四十个车位的停车场，门口那个计数牌就是信号量。',
  s2: 'A semaphore starting at one behaves exactly like a mutex.',
  z2: '初值为一的信号量，行为上就是互斥锁。'
},
{
  ...
  se: 'Two people in a doorway, each waiting for the other to move first.',
  sz: '两个人堵在门口，都等对方先让。',
  s2: 'Always take locks in the same order and deadlock cannot happen.',
  z2: '永远按同一顺序取锁，死锁就不会发生。'
},
{
  ...
  se: 'You keep milk in the fridge, not at the shop.',
  sz: '牛奶放在冰箱里，而不是留在超市。',
  s2: 'There are only two hard problems: cache invalidation and naming things.',
  z2: '只有两个难题：缓存失效和命名。'
},
{
  ...
  se: 'Latency is how long before the first chip arrives, not how many.',
  sz: '延迟是第一根薯条多久上桌，不是上了多少根。',
  s2: 'Report the slowest one percent, not the average.',
  z2: '要报最慢的百分之一，而不是平均值。'
},
{
  ...
  se: 'Throughput is how many meals the kitchen serves per hour.',
  sz: '吞吐量是厨房每小时出多少份餐。',
  s2: 'Batching raised throughput and made the slowest orders slower.',
  z2: '批处理提高了吞吐，却让最慢的订单更慢了。'
},
{
  ...
  se: 'Locking an already-locked door leaves it locked.',
  sz: '给已经锁上的门再锁一次，它还是锁着。',
  s2: 'Send an idempotency key so a retry cannot charge twice.',
  z2: '带上幂等键，重试就不会重复扣款。'
},
{
  ...
  se: 'Five friends must agree on one restaurant, and two keep losing signal.',
  sz: '五个朋友要定同一家餐厅，其中两个还老是断线。',
  s2: 'Raft made consensus teachable in a way Paxos never did.',
  z2: 'Raft 让共识变得可教，这是 Paxos 从没做到的。'
},
{
  ...
  se: 'A meeting cannot decide anything until enough members turn up.',
  sz: '人到得不够，会就什么也定不了。',
  s2: 'Write to three of five and you can survive losing two.',
  z2: '五个里写三个，挂掉两个也还撑得住。'
},
{
  ...
  se: 'Send a group text; everyone gets it, just not at the same second.',
  sz: '群发一条短信，大家都会收到，只是不在同一秒。',
  s2: 'Fine for a like counter, not for a bank balance.',
  z2: '用在点赞数没问题，用在银行余额就不行。'
},
{
  ...
  se: 'A storm cuts the phone line between two offices; both keep working, alone.',
  sz: '暴风雨切断了两个办公室之间的电话线，两边各自照常运转。',
  s2: 'During a partition you must pick: answer, or be correct.',
  z2: '发生分区时你必须二选一：要么应答，要么正确。'
},
{
  ...
  se: 'A conductor does not play anything, yet nothing works without one.',
  sz: '指挥一个音符也不演奏，但没有他一切都乱。',
  s2: 'The tool handles orchestration; you still own the failure modes.',
  z2: '工具负责编排，故障模式还是你的事。'
},
{
  ...
  se: 'A tap you can only open so far, no matter how thirsty you are.',
  sz: '水龙头只能开这么大，不管你多渴。',
  s2: 'Throttle per account, not per address.',
  z2: '按账号限流，而不是按地址。'
},
{
  ...
  se: 'A reed bends in the storm and stands up afterwards.',
  sz: '芦苇在风暴里弯下去，风过了又立起来。',
  s2: 'Resilience is designed in, not added after the outage.',
  z2: '韧性是设计出来的，不是事故之后补的。'
},
{
  ...
  se: 'A night porter you never see, always awake in case someone rings.',
  sz: '一个你从没见过的夜班门房，永远醒着，等人按铃。',
  s2: 'The daemon reopens its log file when you tell it to.',
  z2: '守护进程收到指令时会重新打开日志文件。'
},
{
  ...
  se: 'One flat, four locked bedrooms, four tenants who never meet.',
  sz: '一套房子四间上锁的卧室，四个住户互不照面。',
  s2: 'Containers isolate processes; they are not full virtualization.',
  z2: '容器隔离的是进程，并非完整的虚拟化。'
},
{
  ...
  se: 'A nurse interrupts the queue when someone is bleeding.',
  sz: '有人在流血时，护士会打断排队顺序。',
  s2: 'Without preemption one runaway loop starves everyone else.',
  z2: '没有抢占，一个失控的循环就能饿死其他所有人。'
},
{
  ...
  se: 'The washing-up piles up, so you tell people to stop cooking.',
  sz: '洗碗池堆满了，于是你让人先别做菜。',
  s2: 'Without backpressure the queue grows until the machine falls over.',
  z2: '没有背压，队列会一直涨到机器倒下为止。'
},
{
  ...
  se: 'One printer, six people, all pressing print at once.',
  sz: '一台打印机，六个人同时按下打印。',
  s2: 'Profiling showed the wait was for the lock, not the work.',
  z2: '剖析显示时间花在等锁上，不是在干活。'
},
{
  ...
  se: 'Everyone in the room agrees on exactly what happened, and in what order.',
  sz: '屋里所有人对发生了什么、按什么顺序发生，说法完全一致。',
  s2: 'A stronger promise than "everyone agrees eventually".',
  z2: '这是比“大家最终会一致”更强的承诺。'
},
{
  ...
  se: 'Keep a spare key at your parents house.',
  sz: '在父母家放一把备用钥匙。',
  s2: 'Copies buy you durability, not agreement.',
  z2: '多存几份换来的是不丢，而不是一致。'
},
{
  ...
  se: 'The motorway is full: one more car only makes the queue longer.',
  sz: '高速已经满了，再来一辆车只会让队伍更长。',
  s2: 'A disk at a hundred percent may still be perfectly happy.',
  z2: '磁盘显示百分之百，也可能完全没问题。'
},
{
  ...
  se: 'Ten checkouts open, and everyone queues at the same one.',
  sz: '十个收银台都开着，所有人却排在同一个。',
  s2: 'One popular key made the whole cluster look slow.',
  z2: '一个热门的键就让整个集群看起来很慢。'
},
{
  ...
  se: 'Nine hikers wait at the top for the tenth.',
  sz: '九个人在山顶等第十个。',
  s2: 'The job is only as fast as its slowest task.',
  z2: '整个作业的快慢，取决于最慢的那个任务。'
},
{
  ...
  se: '"Hello" - "Hello" - "Who is this?" Phone calls follow a protocol too.',
  sz: '“喂”“喂”“哪位？”——打电话也是有协议的。',
  s2: 'The protocol tolerates packets arriving out of order.',
  z2: '这个协议容忍数据包乱序到达。'
},
{
  ...
  se: 'Send a sofa in six boxes; each box carries the address.',
  sz: '把沙发拆成六个箱子寄走，每个箱子都写着地址。',
  s2: 'Each packet may take a different road and still arrive.',
  z2: '每个包可以走不同的路，最后都能到。'
},
{
  ...
  se: 'A postal sorting office reads the address and picks the next van.',
  sz: '邮件分拣中心看一眼地址，决定装上哪辆车。',
  s2: 'The router dropped the packet because it had travelled too far.',
  z2: '路由器丢掉了这个包，因为它跑得太远了。'
},
{
  ...
  se: 'Bandwidth is how wide the pipe is, not how fast the water moves.',
  sz: '带宽是管子有多粗，不是水流多快。',
  s2: 'Bandwidth is cheap; the speed of light is not negotiable.',
  z2: '带宽很便宜，光速却不容商量。'
},
{
  ...
  se: 'Shaking hands once showed neither of you held a weapon.',
  sz: '握手最初是为了表明双手都没拿武器。',
  s2: 'The handshake costs one round trip before any data moves.',
  z2: '握手要多花一个往返，之后数据才开始走。'
},
{
  ...
  se: 'A socket is the plug in the wall; the program is the lamp.',
  sz: '套接字是墙上的插座，程序是那盏灯。',
  s2: 'Two programs plug into the same socket and talk.',
  z2: '两个程序插进同一个插座就能对话。'
},
{
  ...
  se: 'One building, many numbered doors. The port number is the door.',
  sz: '一栋楼，许多编号的门，端口号就是那扇门。',
  s2: 'Doors below 1024 need the caretaker to open them.',
  z2: '1024 以下的门要管理员才能开。'
},
{
  ...
  se: 'A street divided into flats: the mask says where the flat number starts.',
  sz: '一条街被分成若干套房，掩码决定门牌号从哪一位算起。',
  s2: 'A /24 leaves room for 254 machines.',
  z2: '一个 /24 能放下 254 台机器。'
},
{
  ...
  se: 'The gate you must pass to leave the courtyard.',
  sz: '要出院子，必须经过那道门。',
  s2: 'The gateway was wrong, so nothing could leave the building.',
  z2: '网关配错了，所以什么也出不了这栋楼。'
},
{
  ...
  se: 'A fire door stops the fire from spreading to the next room.',
  sz: '防火门挡住火，不让它烧到隔壁。',
  s2: 'It drops the packet silently rather than saying no.',
  z2: '它默默丢掉这个包，而不是回一句拒绝。'
},
{
  ...
  se: 'You cannot attend the vote, so a friend votes on your behalf.',
  sz: '你去不了投票，就让朋友代你投。',
  s2: 'The proxy answers first and only asks the server when it must.',
  z2: '代理先自己回答，实在不行才去问服务器。'
},
{
  ...
  se: 'Post a letter inside another envelope to get it through.',
  sz: '把信装进另一个信封里寄，才过得去。',
  s2: 'They tunnel the new protocol through the old one until the network catches up.',
  z2: '在网络跟上之前，他们把新协议套在旧协议里传。'
},
{
  ...
  se: 'A farmer scatters seed by hand across the whole field.',
  sz: '农夫用手把种子撒满整块田。',
  s2: 'One shout to the whole room: "whose phone is this?"',
  z2: '对着满屋子喊一句：“这手机是谁的？”'
},
{
  ...
  se: 'Rush hour: the road is the same width, there are just too many cars.',
  sz: '高峰期：路还是那么宽，只是车太多了。',
  s2: 'Queues grow, then packets start falling off the end.',
  z2: '队列越排越长，然后包就从末尾掉下去了。'
},
{
  ...
  se: 'A song that keeps stuttering is worse than a song that starts late.',
  sz: '一首老是卡顿的歌，比晚开始播的歌更难听。',
  s2: 'Add a small buffer and the stutter disappears.',
  z2: '加一小段缓冲，卡顿就没了。'
},
{
  ...
  se: 'A locked box: anyone can carry it, only the key opens it.',
  sz: '一个上锁的箱子：谁都搬得动，只有钥匙打得开。',
  s2: 'Encrypting in transit does not protect what is sitting on disk.',
  z2: '传输加密保护不了躺在磁盘上的东西。'
},
{
  ...
  se: 'A cipher is the rule for turning a message into gibberish and back.',
  sz: '密码算法就是把消息变成乱码、再变回来的那套规则。',
  s2: 'Turn off the old cipher suites before someone else finds them.',
  z2: '趁别人还没发现，先把老的密码套件关掉。'
},
{
  ...
  se: 'Showing your passport is authentication. Being allowed in is not the same thing.',
  sz: '出示护照是认证，能不能进去是另一回事。',
  s2: 'Authentication proves who you are; authorization decides what you may do.',
  z2: '认证证明你是谁，授权决定你能做什么。'
},
{
  ...
  se: 'A certificate is a letter of introduction signed by someone both sides trust.',
  sz: '证书是一封由双方都信任的人签名的介绍信。',
  s2: 'The outage was a certificate nobody remembered to renew.',
  z2: '这次故障的原因是一张没人记得续期的证书。'
},
{
  ...
  se: 'You know the shop name; the resolver tells you the street address.',
  sz: '你知道店名，解析器告诉你街道地址。',
  s2: 'It remembers the answer until the note expires.',
  z2: '它会记住答案，直到那张便条过期。'
},
{
  ...
  se: 'A submarine sends a pulse and listens for the echo.',
  sz: '潜艇发出一声脉冲，然后听回声。',
  s2: 'It pings fine, so the problem is higher up.',
  z2: 'ping 是通的，所以问题在更上层。'
},
{
  ...
  se: 'The bottle is wide; the neck decides how fast it pours.',
  sz: '瓶身很宽，倒得多快却由瓶颈决定。',
  s2: 'Measure first - the bottleneck is rarely where you guessed.',
  z2: '先测量，瓶颈很少在你猜的地方。'
},
{
  ...
  se: 'One motorway, several lanes, everyone moving at once.',
  sz: '一条高速公路，几条车道，大家同时在走。',
  s2: 'One connection now carries a hundred requests side by side.',
  z2: '一条连接现在并排承载上百个请求。'
},
{
  ...
  se: 'Count the coins twice and compare - if the totals differ, something was lost.',
  sz: '把硬币数两遍再比对，数目对不上就说明丢了东西。',
  s2: 'A checksum catches accidents, not attackers.',
  z2: '校验和能发现意外，挡不住攻击者。'
},
{
  ...
  se: 'A shout fades the further you walk away from it.',
  sz: '喊声越走越远就越听不清。',
  s2: 'Past a hundred metres the signal is too weak to read.',
  z2: '超过一百米，信号就弱到读不出来了。'
},
{
  ...
  se: 'Getting into the car park is free; leaving costs money.',
  sz: '进停车场免费，出来要收钱。',
  s2: 'The design was fine; the bill for leaving was not.',
  z2: '架构没问题，出网的账单才是问题。'
},
{
  ...
  se: 'A wardrobe too tall for the door goes through in pieces.',
  sz: '衣柜比门高，就得拆开搬进去。',
  s2: 'Better to send smaller pieces than to let the road cut them for you.',
  z2: '与其让路上替你切，不如自己发小一点。'
},
{
  ...
  se: 'Two neighbours swap parcels directly instead of paying the post office.',
  sz: '两个邻居直接互换包裹，而不是各自付邮费。',
  s2: 'They stopped buying transit and exchanged traffic as equals.',
  z2: '他们不再购买中转，改为平等地交换流量。'
},
{
  ...
  se: 'A rumour reaches the far end of the office some minutes later.',
  sz: '一条流言几分钟后才传到办公室另一头。',
  s2: 'What people call propagation is really old notes expiring.',
  z2: '人们说的传播，其实只是旧便条在陆续过期。'
},
{
  ...
  se: 'A letter signed with someone else name.',
  sz: '一封署了别人名字的信。',
  s2: 'If you can fake the sender, you can make replies land anywhere.',
  z2: '只要能伪造发件人，就能让回信落到任何地方。'
}
];
